...
trait InteractsWithAuthentication
{
    ...
    public function loginAs($userId, $guard = null)
    {
        ...
        return $this->visit(rtrim(ws_route('dusk.login', ['userId' => $userId, 'guard' => $guard], $this->shouldUseAbsoluteRouteForAuthentication())));
    }
    ...
    {
        return $this->visit(rtrim(ws_route('dusk.logout', ['guard' => $guard], $this->shouldUseAbsoluteRouteForAuthentication()), '/'));
    }
    ...
    {
        $response = $this->visit(ws_route('dusk.user', ['guard' => $guard], $this->shouldUseAbsoluteRouteForAuthentication()));
    ...
    {
        return ws_config('dusk.domain') !== null;
    }
}
