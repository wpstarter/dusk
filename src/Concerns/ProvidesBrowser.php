...
trait ProvidesBrowser
{
    ...
    protected function createBrowsersFor(Closure $callback)
    {
        if (count(static::$browsers) === 0) {
            static::$browsers = ws_collect([$this->newBrowser($this->createWebDriver())]);
        }
     ...
     *
     * @param  \WpStarter\Support\Collection  $browsers
     * @return void
     */
